...
titulo = Label(frame_entrada, text= "Ejercicio 1")
...
subtitulo2 = Label(frame_entrada,  text="Caculador de IVA")
...
etiq_a=Label(frame_entrada, text="Precio = ")
...
logo = PhotoImage(file="impuesto.png" )
etiq_logo = Label(frame_entrada, image=logo)
etiq_logo.place(x=10, y=10)
